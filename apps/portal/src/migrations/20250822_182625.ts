...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
   ...
   CREATE TYPE "public"."enum_users_roles" AS ENUM('admin', 'agent');
  CREATE TYPE "public"."enum_users_tenants_roles" AS ENUM('tenant-admin', 'tenant-viewer');
  CREATE TYPE "public"."enum_services_audience" AS ENUM('citizens', 'businesses', 'residents', 'tourists');
  CREATE TYPE "public"."enum_services_type" AS ENUM('G2C', 'G2B', 'G2G');
  CREATE TYPE "public"."enum_services_access" AS ENUM('online', 'offline', 'hybrid');
  CREATE TYPE "public"."enum_services_status" AS ENUM('active', 'upcoming', 'retired');
  ...
  CREATE TABLE "services_audience" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum_services_audience",
  	"id" serial PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "services_documents_required" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "services" (
  	...
  	"access" "enum_services_access",
  	"status" "enum_services_status" DEFAULT 'active',
  	"eligibility" varchar,
  ...
  ALTER TABLE "services_audience" ADD CONSTRAINT "services_audience_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."services"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "services_documents_required" ADD CONSTRAINT "services_documents_required_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."services"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "services" ADD CONSTRAINT "services_form_id_forms_id_fk" FOREIGN KEY ("form_id") REFERENCES "public"."forms"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "services_audience_order_idx" ON "services_audience" USING btree ("order");
  CREATE INDEX "services_audience_parent_idx" ON "services_audience" USING btree ("parent_id");
  CREATE INDEX "services_documents_required_order_idx" ON "services_documents_required" USING btree ("_order");
  CREATE INDEX "services_documents_required_parent_id_idx" ON "services_documents_required" USING btree ("_parent_id");
  ...
  CREATE INDEX "services_form_idx" ON "services" USING btree ("form_id");
...
export async function down({
  ...
  DROP TABLE "services_audience" CASCADE;
  DROP TABLE "services_documents_required" CASCADE;
  ...
  DROP TYPE "public"."enum_services_access";
